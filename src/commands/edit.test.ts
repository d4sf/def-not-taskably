...
describe('edit command', () => {
  it('edit task title', async () => {
    ...
    await editHandler("1", { title: 'Updated Task One' }, {
  ...
  it('edit task priority', async () => {
    ...
    await editHandler("2", { priority: 'high' as const }, {
      loadTasks: async () => tasks,
      saveTasks,
      log
    });
  ...
  it('edit both title and priority', async () => {
    ...
    await editHandler("3", { title: 'Updated Task Three', priority: 'low' as const }, {
      loadTasks: async () => tasks,
      saveTasks,
      log
    });
